...
`reactOutput()` and `renderReact()` are alternatives to `uiOutput()` / `renderUI()` from the [shiny.react](https://appsilon.github.io/shiny.react/) package, re-exported here for convenience. They provide more direct React rendering control:

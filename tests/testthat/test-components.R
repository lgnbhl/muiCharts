...
test_that("BarSeries() returns shiny.tag, correct name and value", {
  ...
  expect_equal(
    environment(BarSeries("Test")[["children"]][[2]])[["data"]][["props"]][[
      "value"
    ]][["children"]],
    "Test"
  )
...
test_that("LineSeries() returns shiny.tag, correct name and value", {
  ...
  expect_equal(
    environment(LineSeries("Test")[["children"]][[2]])[["data"]][["props"]][[
      "value"
    ]][["children"]],
    "Test"
  )
...
test_that("PieSeries() returns shiny.tag, correct name and value", {
  ...
  expect_equal(
    environment(PieSeries("Test")[["children"]][[2]])[["data"]][["props"]][[
      "value"
    ]][["children"]],
    "Test"
  )
...
test_that("RadarSeries() returns shiny.tag, correct name and value", {
  ...
  expect_equal(
    environment(RadarSeries("Test")[["children"]][[2]])[["data"]][["props"]][[
      "value"
    ]][["children"]],
    "Test"
  )
...
test_that("ScatterSeries() returns shiny.tag, correct name and value", {
  ...
  expect_equal(
    environment(ScatterSeries("Test")[["children"]][[2]])[["data"]][["props"]][[
      "value"
    ]][["children"]],
    "Test"
  )
...
test_that("LegendItemParams() returns shiny.tag, correct name and value", {
  ...
  expect_equal(
    environment(LegendItemParams("Test")[["children"]][[2]])[["data"]][[
      "props"
    ]][["value"]][["children"]],
    "Test"
  )
